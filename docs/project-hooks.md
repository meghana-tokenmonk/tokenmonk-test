...
Recorded measurement: [`spike-results/cloud-agent-bc-abc4fe2f-project-hooks.json`](../spike-results/cloud-agent-bc-abc4fe2f-project-hooks.json). That session booted from invalid JSON at `51eec9c` and never received Cursor-invoked heartbeats, even after fast-forwarding to valid `hooks.json`.
